...
const gameSound = document.querySelector('.game-music');
...
const winSound = document.querySelector('.yay');
...
function enterMenu() {
  ...
  gameSound.play();
  setTimeout(() => introMessage.style.display = 'none', 3500);
}
...
for (let i = 0; i < allButtons.length; i++) {
  allButtons[i].addEventListener('click', buttonMusic);
}
